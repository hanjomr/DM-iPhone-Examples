...
- (void)viewDidLoad {
	...
	TweetParserDelegate *delegate = [[TweetParserDelegate alloc] init];
	[parser setDelegate:delegate];
	[parser parse];
	tweets = [delegate.allTweets retain];
	[parser release];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	mainLabel.text = [[tweets objectAtIndex:indexPath.row] text];
	userLabel.text = [[tweets objectAtIndex:indexPath.row] username];
    return cell;
}
